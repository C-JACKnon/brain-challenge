...
// アプリケーションのバージョン
export const ApplicationVersion: string = '1.1.0';
...
// 取得できるオンラインスコアの日数
export const OnlineScoreDate: number = 3;

// NGワードリスト
export const NgWordList: NgWordListType = {
  hira: ['ちんぽ', 'ちんちん', 'ちんこ', 'まんこ', 'あなる', 'ちくび', 'おっぱい', 'せいじょうい', 'きじょうい', 'たちばっく',
    ...
    'あばずれ', 'せいし', 'ざーめん', 'らんし', 'しゃせい', 'びっち', 'ふぁっく','けつあな'
  ],
  kan: ['珍歩', '珍子', '尻穴', '乳首', '正常位', '騎乗位', '自慰', '性行為', '淫', '風俗', '汁男優', '巨珍', '肉便器', '巨根',
    '巨乳', '爆乳', '我慢汁', '種付', '対面座位', '中出', '顔射', '乳輪', '淫乱', '精子', '卵子', '射精', '尻穴', '性器'
  ],
  kata: ['チンポ', 'チンチン', 'チンコ', 'マンコ', 'アナル', 'チクビ', 'オッパイ', 'セイジョウイ', 'キジョウイ', 'タチバック',
    ...
    'アバズレ', 'セイシ', 'ザーメン', 'ランシ', 'シャセイ', 'ビッチ', 'ファック', 'ケツアナ'
  ],
  hankaku: ['ﾁﾝﾎﾟ', 'ﾁﾝﾁﾝ', 'ﾁﾝｺ', 'ﾏﾝｺ', 'ｱﾅﾙ', 'ﾁｸﾋﾞ', 'ｵｯﾊﾟｲ', 'ｾｲｼﾞｮｳｲ', 'ｷｼﾞｮｳｲ', 'ﾀﾁﾊﾞｯｸ',
    ...
    'ｱﾊﾞｽﾞﾚ', 'ｾｲｼ', 'ｻﾞｰﾒﾝ', 'ﾗﾝｼ', 'ｼｬｾｲ', 'ﾋﾞｯﾁ', 'ﾌｧｯｸ', 'ｹﾂｱﾅ'
  ],
  mix: ['立ちバック', '寝バック', 'AV女優', 'AV男優', 'ヤリちん', 'ヤリまん', 'デカちん', 'デカまら', '手マン', '手まん',
    '手コキ', '手こき', '足こき', '足コキ', 'はめ撮り', 'ハメ撮り', 'まんぐり返し', 'けつ穴', 'ケツ穴'
  ],
